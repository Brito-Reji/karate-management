            ...
            <div className="space-y-1.5">
              ...
              <div className="relative">
                <input
                  ...
                  onChange={handleChange}
                  placeholder="••••••••"
                  className="w-full h-11 px-4 pr-11 rounded-lg bg-zinc-900/50 border border-zinc-800 text-sm text-zinc-200 placeholder-zinc-600 focus:outline-none focus:border-zinc-500 disabled:opacity-50 transition-all"
                />
                <button
                  type="button"
